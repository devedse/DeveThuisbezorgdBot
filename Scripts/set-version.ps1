...
$csprojPath = Join-Path -Path $SolutionRoot -ChildPath "DeveThuisbezorgdBot\DeveThuisbezorgdBot.csproj"
$csprojPathTelegramBot = Join-Path -Path $SolutionRoot -ChildPath "DeveThuisbezorgdBot.TelegramBot\DeveThuisbezorgdBot.TelegramBot.csproj"
$csprojPathWebApp = Join-Path -Path $SolutionRoot -ChildPath "DeveThuisbezorgdBot.WebApp\DeveThuisbezorgdBot.WebApp.csproj"
